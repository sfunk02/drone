...
while True:
    ...
    motor1_pwm.duty_cycle = int(65535 * motor1_baseline - pitch_PID * PID_multiplier)
    motor2_pwm.duty_cycle = int(65535 * motor2_baseline) #int(65535 * motor2_baseline + roll_PID * PID_multiplier)
    motor3_pwm.duty_cycle = int(65535 * motor3_baseline + pitch_PID * PID_multiplier)
    ...
    print("motor2_pwm.duty_cycle: " + str(motor2_pwm.duty_cycle))
